...
export default function Header() {
  return (
    <div className='flex items-center bg-headerBGLight'>
      <div className='flex-1'>
     <img src={logoIcon} alt="logo" className='my-5 ml-24 h-[35px]'/>
     </div>
      <button style={{textTransform:"none"}} className="text-fontButtonPink font-bold text-base bg-buttonBg py-4 px-3 rounded-[13px]">Contact us</button>
